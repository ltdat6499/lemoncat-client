<template>
  <div>
        ...
        <div class="cube__side cube__side--back">
          <div class="screen">
            <div class="video">
              <video
                class="video-player"
                src="./media/sintel.mp4"
                preload="auto"
                poster="media/sintel.jpg"
              >
                <!-- <source
                  src="./media/sintel.ogv"
              ...
              <button
                class="action action--play action--shown"
            ...
            <div class="intro intro--shown">
              <div class="intro__side">
                <h2 class="intro__title">
                  <span class="intro__up"
                    >The Open Cinema <em>presents</em></span
                  >
                  <span class="intro__down"
                    >Make
                    <span class="intro__partial"
                      ><em>by</em> <a>Kaido Jin</a></span
                    ></span
                  >
                </h2>
              </div>
    ...
    <div class="plan">
      ...
      <button class="action action--buy">Back to list</button>
    </div>
    <!-- /plan -->
    <button
      class="action action--lookaround action--disabled"
...
export default {
  mounted() {
    const scripts = ["./js/classie.js", "./js/main.js"];
    let script = document.createElement("script");
    script.setAttribute("src", "./js/modernizr-custom.js");
    ...
    for (const path of scripts) {
      ...
      externalScript.setAttribute("src", path);
