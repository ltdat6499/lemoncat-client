    ...
    >
      <b-row style="padding-top:50px;padding-bottom:20px">
        ...
        <b-col cols="9">
          ...
          <div
            style="display:flex;align-items:center;justify-content:space-between;font-size:16px;width:70%;margin-bottom:15px"
          >
            <span><strong>Hollywood Reporter</strong></span>
            <span><strong>34</strong> Reviews</span>
            <span><strong>20</strong> News</span>
            <span><strong>2k</strong> Followers</span>
          </div>
          <div style="display:flex;align-items:center;font-size:16px;width:70%">
            <span><strong>Thanh Dat</strong></span>
          </div>
        </b-col>
      </b-row>
      ...
      <b-row style="width:100%">
        ...
        >
          <v-tab-item v-for="item in items" :key="item">
            <div v-if="item === 'Reviews'"><reviews></reviews></div>
